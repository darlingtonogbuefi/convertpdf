...
export const handleDownloadAll = async (convertedFiles: ConvertedFile[] | ConvertedFile[][]) => {
  // Flatten in case some items are arrays
  const files: ConvertedFile[] = ([] as ConvertedFile[]).concat(...convertedFiles);
