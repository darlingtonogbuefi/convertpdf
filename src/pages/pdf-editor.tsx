...
export default function PdfEditorPage() {
  ...
  // ✅ FIX: extract filename (needed for correct download naming)
  ...
  // ✅ FIX: pass filename to editor so downloads keep real name
  return <PdfEditor fileUrl={fileUrl} filename={filename} />;
}