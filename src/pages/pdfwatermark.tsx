...
export default function PdfWatermarkPage() {
  ...
  // initialize stable document id (persist across page lifecycle)
  if (!documentIdRef.current) {
    documentIdRef.current =
      sessionStorage.getItem("pdf_document_id") || crypto.randomUUID();

    sessionStorage.setItem("pdf_document_id", documentIdRef.current);
  }
