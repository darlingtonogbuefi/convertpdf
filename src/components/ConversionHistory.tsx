...
interface Conversion {
  ...
  operation?: 'watermark' | 'merge' | 'split' | 'compress' | 'edit' | 'sign' | 'stamp' | 'rotate';
  created_date: string;
}
      ...
      <CardContent>
        <div className="space-y-3">
          {conversions.map((conversion) => {
            ...
            const isPdfOperation =
              conversion.operation !== undefined &&
              conversion.operation in operationLabels;
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      {isPdfOperation ? (
                        <Badge variant="outline" className="text-xs">
                          {operationLabels[conversion.operation!]}
                        </Badge>
                      ) : (
                        <>
                          <Badge variant="outline" className="text-xs">
