// src\components\ConversionTypePopup.tsx
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-3 gap-3 mt-10 mb-4 flex-grow auto-rows-fr">
          {conversionOptions
            ...
            .map((option, index, filteredOptions) => {
              ...
              const remainder = filteredOptions.length % 3;
              const isLast = index === filteredOptions.length - 1;
              const isSecondLast =
                index === filteredOptions.length - 2;

              let alignmentClass = '';

              // One last item -> center
              if (remainder === 1 && isLast) {
                alignmentClass = 'col-start-2';
              }

              // Two last items -> left and right
              if (remainder === 2) {
                if (isSecondLast) alignmentClass = 'col-start-1';
                if (isLast) alignmentClass = 'col-start-3';
              }
              ...
              return (
                <button
                  ...
                  type="button"
                  onClick={() =>
                    onConfirmType(option.id as ConversionType)
                  }
                  className={cn(
