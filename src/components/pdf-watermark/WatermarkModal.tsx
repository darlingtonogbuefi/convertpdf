...
export default function WatermarkModal({ open, onClose, file, onApply, documentId }: any) {
      ...
      >
        ...
        <div className="flex gap-6 border-b">
          <button
            ...
            className={`relative pb-2 text-xs transition-colors ${type === "image"
          ...
          <button
            ...
            className={`relative pb-2 text-xs transition-colors ${type === "text"
                ? "text-blue-600 font-semibold"
                : "text-gray-600 font-semibold hover:text-blue-500"
              }`}
          >
        ...
        {type === "image" && (
          <div className="mt-5 flex flex-col justify-start items-center w-full">
            ...
            <div
              className={`${imagePreviewClass} ${isDragging ? "border-blue-500 bg-blue-50 scale-[1.02]" : ""
                }`}
              onClick={() =>
        ...
        <div className="flex justify-end gap-1.5 mt-auto text-xs">
          ...
          <Button
            ...
            className={`border rounded px-2 py-1 text-xs ${isApplyActive && !loading
