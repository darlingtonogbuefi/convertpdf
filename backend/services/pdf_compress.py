...
def _run_ghostscript(input_pdf: Path, output_pdf: Path, compression_level: str = "max"):
    ...
    gs_quality, image_resolution = level_map.get(
        compression_level,
        ("screen", 100),
    )
...
def compress_pdf(
    ...
    #
    # Disabled because replacing image streams directly with
    # PikePDF is unreliable. Ghostscript performs image
    # recompression during the next stage.
    # -----------------------
